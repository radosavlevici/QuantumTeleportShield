                        ...
                        dbc.Col([
                            html.Div([
                                ...
                                dcc.Graph(
                                    figure={
                                        'data': [
                                            # Noduri quantum (puncte)
                                            {
                                                'x': [100, 200, 300, 400, 120, 250, 350],
                                                'y': [80, 150, 80, 120, 180, 50, 200],
                                                'mode': 'markers',
                                                'marker': {
                                                    'size': 15,
                                                    'color': '#5db2ff',
                                            ...
                                            # Indicatori noduri active (puncte mai mici verzi)
                                            {
                                                'x': [100, 200, 300, 400, 120, 250, 350],
                                                'y': [80, 150, 80, 120, 180, 50, 200],
                                                'mode': 'markers',
                                                ...
                                                'type': 'scatter',
                                                'name': 'Status Noduri: Active'
                                            },
                                            # Conexiuni quantum (linii)
                                            {
                                                'x': [100, 200], 'y': [80, 150],
                                                'mode': 'lines', 'line': {'color': '#5db2ff', 'width': 2},
                ...
                dbc.CardBody([
                    ...
                    dbc.Row([
                        dbc.Col([
                            ...
                            dbc.Card([
                                dbc.CardHeader(html.H5("STANDARD", className="text-center text-primary")),
                                dbc.CardBody([
